<?php
/**
 * Demographics County Data Widget
 */



/**
 * Class ISSSLPG_Admin_County_Demographics_Data_Widget
 */
class ISSSLPG_Admin_County_Demographics_Data_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ISS: County Demographics Data";
	...
	public function widget( $args, $instance )
	{
		...
		$data = array(
			'population'    => $county->get_population(),
			'households'    => $county->get_households(),
			'median_income' => $county->get_median_income(),
			'land_area'     => $county->get_land_area(),
			'water_area'    => $county->get_water_area(),
		);
