...
/**
 * Class ISSSLPG_Admin_Map_Widget
 */
class ISSSLPG_Admin_Map_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ISS: Map";
	const WIDGET_DESCRIPTION = "Displays a map of the landing page's location.";
	...
	public function widget( $args, $instance )
	{
		...
		<?php echo $title; ?>
		<?php echo ISSSLPG_Landing_Page_Api::get_map( $height ); ?>
