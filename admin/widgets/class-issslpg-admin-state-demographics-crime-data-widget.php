<?php
/**
 * Demographics State Crime Data Widget
 */



/**
 * Class ISSSLPG_Admin_State_Demographics_Crime_Data_Widget
 */
class ISSSLPG_Admin_State_Demographics_Crime_Data_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ISS: State Crime Data";
