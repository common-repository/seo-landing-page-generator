<?php
/**
 * Demographics City Data Widget
 */



/**
 * Class ISSSLPG_Admin_City_Demographics_Data_Widget
 */
class ISSSLPG_Admin_City_Demographics_Data_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ISS: City Demographics Data";
	...
	public function widget( $args, $instance )
	{
		...
		$data = array(
			...
			'households'    => $location->get_households(),
			'median_income' => $location->get_median_income(),
			'land_area'     => $location->get_land_area(),
			'water_area'    => $location->get_water_area(),
