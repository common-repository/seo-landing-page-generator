<?php
/**
 * Demographics Crime Data Widget
 */



/**
 * Class ISSSLPG_Admin_City_Demographics_Crime_Data_Widget
 */
class ISSSLPG_Admin_City_Demographics_Crime_Data_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ISS: City Crime Data";
...
//		$crime_data = ISSSLPG_Landing_Page_Api::get_location_climate_data();
		$location = new ISSSLPG_Public_Location();
		$crime_data = $location->get_crime_data();
